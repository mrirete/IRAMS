                        ...
                        <div className="min-w-0 w-full lg:w-auto">
                            ...
                            {(() => {
                                ...
                                const line = o.source === 'weibull_analysis'
                                    ...
                                    : o.source === 'rcm'
                                        ? `Generated by RCM study (strategy ${o.strategy_code ?? '—'})`
                                ...
                                return (
                                    <div className="pl-8 lg:pl-0 mt-1.5 space-y-0.5">
                                        <p className="text-[11px] text-primary-700 bg-primary-50 border border-primary-100 rounded-lg px-2.5 py-1 inline-flex items-center gap-1.5">
