...
const genericWorkOrderHistory: CmmsTemplate = {
    ...
    build: () => makeWorkbook(
        ...
        [
            ...
            ['Costs / Downtime / Labor Hours', 'Plain numbers. Optional, but cost data is the single most valuable input for money-ranked findings; labor hours power maintainability analysis.'],
