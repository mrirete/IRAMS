...
`,
    ...
    hazop: {
        ...
        badge: 'HAZOP',
        headerGradient: 'bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900',
        ...
        sendBtn: 'bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700',
        ...
        fabGradient: 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500',
...
`,
    ...
    lopa: {
        ...
        badge: 'LOPA',
        headerGradient: 'bg-gradient-to-r from-violet-900 via-purple-800 to-violet-900',
        iconGradient:   'bg-gradient-to-br from-violet-500 to-purple-600',
        iconShadow:     'shadow-violet-500/20',
        contextBg: 'bg-violet-50', contextBorder: 'border-violet-100',
        contextText: 'text-violet-800', contextAccent: 'text-violet-600',
        contextCountBg: 'bg-violet-100', contextCountText: 'text-violet-700',
        userBubble: 'bg-violet-600', userTimestamp: 'text-violet-200',
        sendBtn: 'bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700',
        inputRing: 'focus:ring-violet-500 focus:border-violet-500',
        chipHover: 'hover:border-violet-400 hover:bg-violet-50 hover:text-violet-700',
        sparkleColor: 'text-violet-500',
        fabGradient: 'bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500',
        fabShadow: 'shadow-violet-500/30 hover:shadow-violet-500/40',
