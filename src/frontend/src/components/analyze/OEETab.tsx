                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1 bg-white border border-slate-200 rounded-xl shadow-sm p-5 space-y-4">
                        <div className="flex items-center gap-2 text-sm font-bold text-slate-800 pb-2 border-b border-slate-100">
                            <Gauge size={16} className="text-primary-600" /> Enter Asset Parameters
                        </div>
                        <form onSubmit={handleCalculate} className="space-y-3.5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full text-xs bg-slate-50 border border-slate-200 rounded-lg p-2 font-semibold text-slate-700 focus:outline-none focus:border-primary-500"
                            ...
                            <button
                                type="submit"
                                className="w-full flex items-center justify-center gap-2 mt-4 px-4 py-2.5 bg-gradient-to-r from-primary-600 to-primary-600 hover:from-primary-700 hover:to-primary-700 text-white font-semibold rounded-xl text-xs transition-all shadow-md hover:shadow-lg"
                            >
                                    ...
                                    <div className="pt-6 space-y-4">
                                        ...
                                        <div className="h-6 w-full bg-slate-100 rounded-lg overflow-hidden flex shadow-inner">
                                            ...
                                            <div
                                                ...
                                                className="bg-gradient-to-r from-primary-500 to-primary-500 h-full flex items-center justify-center text-white text-[9px] font-bold"
                                            ...
                                            <div
                                                ...
                                                className="bg-primary-500/80 h-full flex items-center justify-center text-white text-[9px] font-bold"
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                                            <div className="p-3 bg-primary-50/50 rounded-lg border border-primary-100">
                                                ...
                                                <div className="text-sm font-black text-primary-700">{activeResult.netProductiveHours.toFixed(1)} hrs</div>
                                            </div>
                                            <div className="p-3 bg-primary-50/50 rounded-lg border border-primary-100">
                                                <div className="text-slate-400 text-[9px] font-bold uppercase">Availability Loss</div>
                                                <div className="text-sm font-black text-primary-700">{activeResult.availabilityLossHours.toFixed(1)} hrs</div>
                                            </div>
                                        ...
                                        <tr key={rec.id} className="hover:bg-slate-50 transition-colors">
                                            ...
                                            <td className="px-4 py-3.5">
                                                <div className="flex items-center gap-2">
                                                    <div className="w-12 bg-slate-100 rounded-full h-1.5">
                                                        <div className="bg-primary-600 h-1.5 rounded-full" style={{ width: `${rec.oee * 100}%` }} />
                                                    </div>
                                            ...
                                            <td className="px-4 py-3.5 text-right space-x-1.5">
                                                <button
                                                    ...
                                                    className="px-2 py-1 bg-primary-50 border border-primary-200 text-primary-600 text-[10px] font-bold rounded hover:bg-primary-100 transition-colors"
                                                >
                                                    Select
                                                </button>
                                            </td>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {history.map((rec) => (
                            <div
                                key={rec.id}
                                onClick={() => handleLoadInput(rec)}
                                className={`p-4 rounded-xl border transition-all cursor-pointer relative group ${activeResult?.id === rec.id ? 'border-primary-500 bg-primary-50/20 shadow-md scale-[1.01]' : 'border-slate-200 bg-white hover:border-slate-300 hover:shadow-sm'}`}
                            >
                                <button
