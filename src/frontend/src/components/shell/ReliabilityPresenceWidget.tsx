...
const ROLE_BADGE_CLASSES: Record<string, string> = {
    ...
    ENGINEER: 'bg-primary-500/20 text-primary-300 border-primary-500/40',
    RELIABILITY_ENG: 'bg-primary-500/20 text-primary-300 border-primary-500/40',
...
const ROLE_AVATAR_GRADIENTS: Record<string, string> = {
    ...
    ENGINEER: 'from-primary-500 to-blue-600',
    RELIABILITY_ENG: 'from-primary-500 to-blue-600',
    PLANNER: 'from-blue-500 to-sky-600',
    TECHNICIAN: 'from-emerald-500 to-primary-600',
